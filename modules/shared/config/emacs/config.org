...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/ssstein/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/ssstein/bin" "/profile/bin" "/Users/ssstein/.npm-packages/bin" "/Users/ssstein/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
